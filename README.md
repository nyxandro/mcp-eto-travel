...
- `find_any_tour` — поиск одного подходящего тура по структурированным аргументам
- `find_tour_options` — поиск небольшой подборки туров с категориями `budget`, `optimal`, `premium`
...
Подборка из нескольких вариантов:
